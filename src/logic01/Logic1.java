...
public class Logic1 {
    public boolean cigarParty(int cigars, boolean isWeekend) {
         ...
         */
        return cigars <= 60 && cigars >= 40 && !isWeekend ||
                cigars >= 40 && isWeekend;
    }
    ...
    public int dateFashion(int you, int date) {
         ...
         * and "date" is the stylishness of your date's clothes. The result getting the table is encoded
         * as an int value with 0=no, 1=maybe, 2=yes. If either of you is very stylish, 8 or more,
    ...
    public int caughtSpeeding(int speed, boolean isBirthday) {
        ...
        if (speed <= 60 + bd) return 0;
        if (speed >= 61 + bd && speed <= 80 + bd) return 1;
        return 2;
    }
    ...
    public boolean in1To10(int n, boolean outsideMode) {
         ...
         */
        return (!outsideMode && 1 <= n && 10 >= n) ||
                (outsideMode && (1 >= n || 10 <= n));
    }
    ...
    public boolean nearTen(int num) {
         ...
         *
         ...
         nearTen(19) → true
         */
        return (num - 1) % 10 == 0 || (num + 1) % 10 == 0 ||
                (num + 2) % 10 == 0 || (num - 2) % 10 == 0 || num % 10 == 0;
    }
    ...
    public String fizzString(String str) {
        ...
        boolean bizz = str.endsWith("b");
        if (fizz && bizz) return "FizzBuzz";
        if (fizz) return "Fizz";
        if (bizz) return "Buzz";
        return str;
    }
    ...
    public int withoutDoubles(int die1, int die2, boolean noDoubles) {
         ...
         */
        if (noDoubles && die1 == die2 && die1 != 6) return die1 + die2 + 1;
    ...
    public int sumLimit(int a, int b) {
        ...
        int sumL = String.valueOf(a + b).length(),
                aL = String.valueOf(a).length();

        if (sumL == aL) return a + b;
        return a;
    }
