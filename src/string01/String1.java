...
public class String1 {
    ...
    public String makeOutWord(String out, String word) {
         ...
         * the middle of the out string, e.g. "<<word>>". Note: use str.substring(i, j) to extract
    ...
    public String twoChar(String str, int index) {
         ...
         *
         ...
         twoChar("java", 3) → "ja"
         */
        if(str.length()-1 < index + 1 || index + 1 < 2) return str.substring(0,2);
    ...
    public boolean hasBad(String str) {
        ...
        if (str.length() == 3 && str.charAt(0) != 'b') return false;
    ...
    public String lastTwo(String str) {
        ...
        char aCh = str.charAt(str.length()-2);
        char bCh = str.charAt(str.length()-1);


        return str.substring(0,str.length()-2) + bCh + aCh;
    }
    ...
    public String seeColor(String str) {
        ...
        String possibleRed = str.substring(0,3);

        if(!possibleBlue.equals("not")){
            possibleBlue = str.substring(0,4);
        }

        if(possibleRed.equals("red")){
            return "red";
        } else if (possibleBlue.equals("blue")){
            return "blue";
        }
    ...
    public String deFront(String str) {
         ...
         * The string may be any length. Harder than it looks.
         ...
         deFront("away") → "aay"
         */
        char possibleA = str.charAt(0);
        char possibleB = str.charAt(1);
        String theRest = str.substring(2);

        if(possibleB == 'b') theRest = possibleB + theRest;
        if(possibleA == 'a') theRest = possibleA + theRest;
    ...
    public String withoutX(String str) {
        ...
        if(str.length() == 0 || str.equals("x")) return "";

        char possibleX01 = str.charAt(0);
        char possibleX02 = str.charAt(str.length()-1);

        if (possibleX01 == 'x' && possibleX02 == 'x'){
            return str.substring(1, str.length()-1);
        }
    ...
    public String withoutX2(String str) {
        ...
        if(str.length() == 0 || str.equals("x") || str.equals("xx")) return "";

        char possibleX01 = str.charAt(0);
        char possibleX02 = str.charAt(1);
        ...
        if (possibleX01 != 'x' && possibleX02 == 'x') {
            return possibleX01 + str.substring(2);
        }
